        ...
        <Section id="galeria" className="bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Galería Institucional</h2>
              <p className="text-gray-600">Momentos que definen nuestra labor.</p>
            </div>
            ...
            >
              {images.map((src, index) => (
                <SwiperSlide key={index}>
                  <div className="overflow-hidden rounded-xl shadow-md aspect-[4/3] group">
                    <img 
                      src={src} 
